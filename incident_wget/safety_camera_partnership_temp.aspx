...
<head><title>
	Safety camera partnership temp closure
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian and Borders Police, safety camera partnership, office closed, storm damage" /><meta name="description" content="Safety camera partnership office relocated due to storm damage" /></head>
<body>
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Safety camera partnership temp</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">05 January 2012 11:38</span>
...
<p>For your information the Safety
Camera&nbsp;&nbsp;Partnership&nbsp;&nbsp;office&nbsp;encountered
substantial storm damage on Tuesday 3 January, 2012.&nbsp; Due to
the repair work required,&nbsp;staff have been relocated to
alternative&nbsp;&nbsp;offices&nbsp;. This means that there is no
one available to take telephone calls at
the&nbsp;&nbsp;Partnership&nbsp;.<br />
<br />
An answer machine has been installed, advising the
office&nbsp;&nbsp;that it&nbsp;is closed due to storm damage and
will remain so until the early next&nbsp; week&nbsp;.&nbsp;Callers
have been asked to refer to our website for further
information:<br /></p>
<table summary="Box">
<tbody>
<tr>
<td><img width="21" alt="Link" title="Link" src="/images/link_icon.jpg" height="21"/></td>
<td><a onclick="window.open(this.href, '_blank'); return false;" href="http://www.lbsafetycameras.co.uk/" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">Lothian and Borders safety
cameras</a></td>
</tr>
</tbody>
</table>
<br />
<p>Fixed camera and mobile deployment will continue through this
closure as only office facilities for processing and viewing have
been affected.<br />
<br />
Email enquires will be dealt with in the normal manner and can be
sent to:</p>
<table summary="Box">
<tbody>
<tr>
<td><img width="32" alt="Email icon" title="Email icon" src="/images/1.email.png" height="32"/></td>
<td><a href="mailto:camera@lbp.pnn.police.uk"><strong>camera@lbp.pnn.police.uk</strong></a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
