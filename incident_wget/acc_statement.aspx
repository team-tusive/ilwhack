...
<head><title>
	Assistant Chief Constable statement
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian and Borders Police, Capital Policing Costs, Assistant Chief Constable, Iain Livingstone" /><meta name="description" content="Following the publication of capital policing costs, including Operation Opal, in the Lothian and Borders Police Board papers, Assistant Chief Constable Iain Livingstone has issued a statement" /></head>
<body>
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">10 November 2011 12:17</span>
...
<table style="WIDTH: 683px; HEIGHT: 100px" summary="box">
<tbody>
<tr>
<td>
<p>Following the publication of capital policing costs, including
Operation Opal, in the Lothian and Borders Police Board papers,
Assistant Chief Constable Iain Livingstone issued the following
statement.</p>
<span><br />
"Lothian and Borders Police has a wealth of experience in policing
the many and diverse major events which are associated with the
international status that Edinburgh enjoys.<br />
<br />
Occasions such as the State visit, where the Queen welcomed the
Pope to Scotland, attract worldwide attention to
Edinburgh.</span></td>
<td class="ImmTextAlign_Left ImmVerticalAlign_Top"><img width="150" alt="Assistant Chief Constable Iain Livingstone" class="BorderImageRight" title="Assistant Chief Constable Iain Livingstone" src="/images/acc_livingstone150.gif" height="125"/>&nbsp;</td>
</tr>
</tbody>
</table>
<p>"The costs incurred during a major policing operation vary,
based on the event taking place, but are always appropriate and
proportionate.<br />
<br />
"In the case of the wedding of Zara Phillips to Mike Tindall this
summer, the policing operation reflected the fact that the entire
lineage of the monarchy was visiting Edinburgh for an event which
spanned three days.<br />
<br />
"If current trends continue, the Force anticipates there will be
increasing demand for Edinburgh to provide the backdrop for major
events.<br />
<br />
"We will continue to police such events, however it must be
recognised there are cost implications.<br />
<br />
"The Force continues to monitor spending on all aspects of policing
but will continue to provide the highest standard of service to our
communities while working within this climate of austerity."</p>
                </div>
                <div class="cell250">
