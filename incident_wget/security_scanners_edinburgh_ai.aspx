...
<head><title>
	Security scanners Edinburgh airport
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="press release,lbp, security scanners,airport" /><meta name="description" content="The introduction of security scanners at Edinburgh Airport represent another layer of security designed to protect traveller safety" /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="security_scanners_edinburgh_ai.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Security scanners Edinburgh ai</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">03 September 2012 11:45</span>
...
<p><strong>Information&nbsp;about the introduction of&nbsp;security
scanner equipment&nbsp;at Edinburgh Airport</strong></p>
<p class="MsoBodyText"><strong>&nbsp;</strong></p>
<table summary="box">
<tbody>
<tr>
<td class="ImmTextAlign_Left ImmVerticalAlign_Top">
<p class="MsoBodyText">The introduction of security scanners at
Edinburgh Airport represent another layer of security designed to
protect traveller safety.&nbsp; The purpose of the scanner is to
detect any concealed threat or contraband being carried by
passengers.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Lothian and Borders Police welcome the
extensive safeguards developed to protect privacy as the image
produced by the scanner is a generic stick-like figure with no
distinguishable features, meaning individuals cannot be
recognised.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoBodyText">We acknowledge some people may be
apprehensive about the implications for passenger privacy; however
we support our partners at Edinburgh Airport in providing accurate
information about the technology in order to alleviate any
concerns.&nbsp;</p>
<p class="MsoBodyText">&nbsp;</p>
<p class="MsoBodyText">Edinburgh Airport is required to introduce
security scanners (also known as body scanners) by the Department
for Transport (DfT). The project is owned and managed solely by
Edinburgh Airport and&nbsp;went live on the 1<sup>st</sup>
September 2012.</p>
</td>
<td>
<table summary="box">
...
<tr>
<td>
<p class="legend"><img width="325" alt="Airport scanner image" title="Airport scanner image" src="/images/scanner_image.jpg" style="MARGIN-LEFT: 5px" height="322"/></p>
<p class="legend ImmTextAlign_Center">Actual scanner image</p>
</td>
</tr>
</tbody>
</table>
...
<p class="MsoBodyText">&nbsp;</p>
<p class="MsoNormal">The scanners at Edinburgh Airport will be an
additional screening measure used for all flights departing from
the airport.&nbsp; Edinburgh Airport can assure passengers
selection for scanning will not be based on personal
characteristics such as disability, sex, gender reassignment, age,
race, religion or belief or sexual orientation.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Edinburgh Airport will communicate their use
of this equipment to passengers via their website and by using
banners, posters, information leaflets and display
screens.&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">In addition to this information provided by
the Airport, there is public information/guidance on the DfT
website (<a href="http://www.dft.gov.uk/publications/information-on-the-implementation-of-security-scanners/">http://www.dft.gov.uk/publications/information-on-the-implementation-of-security-scanners/</a>)
which includes a Code of Practice for the Acceptable Use of
Security Scanners in an Aviation Security Environment and an
Equality Impact Assessment Document.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal"></p>
<table summary="box">
<tbody>
...
<td><a id="Template_ctl09_ctl00_linkToDocument" href="../../../../../files/Information/EdAir_BodyScanners_leaflet.pdf" target="_blank">Download Edinburgh Airport infromation leaflet about security scanners</a></td>
</tr>
</tbody>
</table>
                </div>
