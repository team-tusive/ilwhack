...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian and Borders Police, safety advice, weather safety, " /><meta name="description" content="Lothian and Borders Police warn against all non-essential travel after 2pm. Here is some further safety advice." /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="safety_tips_for_severe_winds.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Safety tips for severe winds</li>
...
<p><strong>During severe weather conditions, LBP advise taking the
following precautions.</strong></p>
<p>&nbsp;</p>
<p class="MsoNormal"><strong>If you are indoors:</strong></p>
<ul>
<li>Close your windows and doors, plus curtains, shutters, blinds
and secondary glazing</li>
<li>Stay away from windows etc</li>
</ul>
<p class="MsoNormal"><strong><br />
If you are outdoors</strong>:</p>
<ul>
<li>Go into a building as soon as possible.</li>
</ul>
<p class="MsoBodyTextIndent2"><strong><br />
If no buildings are available</strong>:</p>
<p class="MsoBodyTextIndent2">&nbsp;</p>
<ul>
<li class="MsoBodyTextIndent2">Find and stay in a low, dry
spot</li>
<li class="MsoBodyTextIndent2">Beware of flooding</li>
<li>Do not shelter under tall structures like poles and trees</li>
</ul>
<p class="MsoNormal"><strong><br />
Keep listening to your radio</strong> and heed the advice
given.&nbsp;</p>
<p class="MsoNormal"><br />
On <strong><a onclick="window.open(this.href, '_blank'); return false;" href="http://twitter.com/" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">Twitter</a></strong>, you can follow a number
of feeds for up to the minute information, for example:<br /></p>
<ul>
<li>@lbp_police for general advice</li>
<li>@radioforthnews, @BBCScotlandNews for school closures</li>
<li>@on_lothianbuses, @trafficscotland, @ScotRail for traffic and
travel warnings</li>
<li>Your local council Twitterfeed.</li>
</ul>
<p class="MsoNormal"><br />
Alternatively see their websites for more information.</p>
<p class="MsoNormal"><strong><br />
If you are forced to go outside:</strong></p>
<ul>
<li>Put on tough wearing clothing and shoes to help shield you
from&nbsp;being injured&nbsp;by debris.</li>
</ul>
<p class="MsoNormal"><strong><br />
If you live on the coastline:</strong></p>
<ul>
<li>Remember that the action of the waves can be much more damaging
to your house than the wind.</li>
</ul>
<p class="MsoNormal"><strong><br />
After the storm passes:</strong></p>
<ul>
<li>Be on the lookout for downed power lines that may still be
active.</li>
<li>Take photos of any damage done to your home to help claim it
back on insurance</li>
</ul>
                </div>
                <div class="cell250">
