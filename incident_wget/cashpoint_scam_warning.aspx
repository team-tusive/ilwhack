...
<head><title>
	CashPoint Scam Warning, Edinburgh
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian Borders, Press Release, Cash Point Scam" /><meta name="description" content="Police in Edinburgh are investigating a spate of incidents that happened in the Capital where bank machines were tampered with. 
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">04 October 2011 12:58</span>
...
<p>Police in Edinburgh are investigating a spate of incidents that
happened in the Capital where bank machines were tampered with.</p>
<p>&nbsp;</p>
<p>Cashpoints in George Street, Raeburn Place and Boswall Parkway
were all targeted between Sunday and Monday by having a plastic
covering placed over the dispenser, which prevents money from being
withdrawn.</p>
<p>&nbsp;</p>
<p class="MsoNormal"></p>
<p class="MsoNormal">The covering is intended to trap the money in
the machine before it becomes visible, leading the user to believe
that the transaction has failed.&nbsp; In reality, the cash can be
recovered by simply removing the covering, which is disguised to
look as if it is part of the ATM.<br />
<br /></p>
<p class="MsoNormal"></p>
<p class="MsoNormal">A police spokesman said: "We are appealing for
any information that can help us trace those responsible for
placing these devices on cashpoints around the city, and we would
urge members of the public who notice anyone tampering with ATMs to
contact police immediately.<br />
<br /></p>
<p class="MsoNormal"></p>
<p class="MsoBodyText">"In the meantime, we would urge people to
study closely any ATM before they use it, and if they notice
anything suspicious, to contact police."</p>
                </div>
                <div class="cell250">
