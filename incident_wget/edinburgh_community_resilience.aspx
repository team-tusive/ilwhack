...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Edinburgh Community Resilience Week,LBP,press release" /><meta name="description" content="Edinburgh Community Resilience Week" /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="edinburgh_community_resilience.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Edinburgh Community Resilience</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">27 February 2012 11:35</span>
...
<p>Lothian and Borders Police are working in partnership with City
of Edinburgh Council and the Edinburgh Chamber of Commerce to
deliver the fourth annual Edinburgh Community Resilience
Week.<br />
<br />
The three-day event is designed to equip businesses large and small
with the knowledge required to cope with a major incident, such as
a terrorist attack, taking place in the Capital.<br />
<br />
Leading figures in the fields of business resilience and national
security will speak at the event, which begins today (Tuesday) with
a one-day Council-led conference at Edinburgh City Chambers.<br />
<br />
The rest of the week will encompass police-led events which are
structured around three of the four strands of the Government's
Counter Terrorism CONTEST - Prevent, Protect and Prepare.<br />
<br />
The week culminates with a Counter Terrorism Security Conference,
which has attracted high calibre speakers. As part of the continued
partnership approach adopted within Edinburgh, Standard Life is
providing venues and support for the police-led events.<br />
<br />
Assistant Chief Constable Iain Livingstone, from Lothian and
Borders Police, said: "We are delighted to be working alongside our
partners to deliver the fourth annual Edinburgh Community
Resilience Week, which brings a range of leading figures in the
fields of business resilience and national security to the Capital
to share their knowledge and expertise.<br />
<br />
"The programme of events will help businesses and organisations
ensure they are prepared for a major incident, and assist in
maintaining Edinburgh's reputation as a safe place to live, work
and visit."<br />
<br />
<span>Councillor Tom Buchanan, Convener of the Economic Development
Committee at City of Edinburgh Council, said: "Edinburgh is a
renowned business city, and it is important that we have robust
plans in place to deal with all eventualities.<br />
<br />
"The annual Community Resilience Week offers businesses of all
sizes insight into how best to prepare for major
incidents."</span></p>
<p>&nbsp;</p>
<p>Graham Birse, Deputy Chief Executive of Edinburgh Chamber of
Commerce, said: "Business continuity is not just a matter for large
enterprises, small businesses are also vulnerable to unexpected
events that can damage their capacity to trace and employ
people.<br />
<br />
"Resilience Week gives local businesses a unique opportunity to
engage with the professionals in this field in order to develop and
protect their own organisation."<br />
<br />
Paul Chong, Group IT and Commercial Director at Standard Life,
said: "Resilience Week has established itself as an extremely
important event in the Edinburgh business calendar.<br />
<br />
"For companies like ourselves it is essential we develop our
thinking and share insight with business continuity experts and our
peers to allow us to protect our organisations effectively. So we
are delighted to be helping to host the event again this year."</p>
<p>&nbsp;</p>
<p class="MsoNormal"></p>
<table summary="Box">
<tbody>
...
<td><a onclick="window.open(this.href, '_blank'); return false;" href="http://www.edinburgh.gov.uk/downloads/download/1970/community_resilience_week_delegate_2012" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">
Edinburgh Resilience Week - Edinburgh Council website</a></td>
</tr>
</tbody>
</table>
<p class="MsoNormal">&nbsp;</p>
