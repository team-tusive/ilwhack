...
<head><title>
	Street Soccer Summer Initiative
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="lothian and borders police, press release, street soccer scotland, football, mayfield, cowden park" /><meta name="description" content="Lothian and Borders Police have been working in partnership with Street Soccer (Scotland) to develop a youth diversionary programme to be run throughout the summer holidays in a bid to engage with local youths and take into account the needs of the local community." /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="street_soccer_initiative.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Street Soccer Initiative</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">04 August 2012 17:34</span>
...
<p class="MsoNormal"><img width="660" alt="Street Soccer Scotland logo" class="BorderImage" title="Street Soccer Scotland logo" src="/images/streetsoccerscot_660_2.jpg" height="263"/></p>
<p class="MsoNormal"><br />
Lothian and Borders Police have been working in partnership with
Street Soccer (Scotland) to develop a youth diversionary programme
to be run throughout the summer holidays in a bid to engage with
local youths and take into account the needs of the local
community.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal"></p>
<table style="WIDTH: 70%" summary="box" class="ImmTS_Default">
<caption>Event details - <strong>attendance is
free!</strong></caption>
<thead>
<tr>
...
<tbody>
<tr>
<td><a onclick="window.open(this.href, '_blank'); return false;" href="http://www.midlothian.gov.uk/info/532/centres_pools_and_pitches/118/mayfield_leisure_centre" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">
Mayfield Leisure Centre</a></td>
<td>Every Friday, from&nbsp;6 Jul - 17 Aug</td>
<td>5.30pm - 8.30pm</td>
</tr>
<tr>
<td><a onclick="window.open(this.href, '_blank'); return false;" href="http://www.midlothian.gov.uk/info/532/centres_pools_and_pitches/572/pitches_and_pavilions/6" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">
Cowden Park, Dalkeith</a></td>
<td>Every Saturday, from 7 Jul - 18 Aug</td>
<td>6.30pm - 9.30pm</td>
</tr>
</tbody>
</table>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Street Soccer (Scotland) is a non-profit
social enterprise that delivers a range of football related
services, inspired by personal experience of how sport can create
real positive change, whilst developing individuals into making
positive choices in their lives.&nbsp; Young people will be
provided with an opportunity to meet new people, improve their
physical and mental health and increase their confidence.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Youth Community Officers, PC Kathryn Johnstone
and PC Lynne Cochrane have been working with David Duke, CEO Street
Soccer (Scotland) to organise this summer initiative, which will
take place at the following locations in order to encourage a wide
range of young people to attend.<br />
<br />
Street workers and local youth groups as well as members from
Lothian and Borders Community Policing Team will all be involved to
provide support and encouragement.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">The programme is free and participants can
attend as many sessions as they want in either location.&nbsp;
Males and females are both welcome between the ages of 12 &ndash; 18
years.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">The sessions will include</p>
<p class="MsoNormal">&nbsp;</p>
<ul>
<li>Fun Games</li>
<li>Skills sessions</li>
<li>Careers Advice</li>
<li>Cup Tournaments and Prizes</li>
</ul>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">If you have an enquiry please contact the
YCO&rsquo;s on:</p>
<p class="MsoNormal"></p>
<table summary="box">
<tbody>
...
<td><a href="mailto:EDIVYCODalkeithNewbattle@lbp.pnn.police.uk">EDIVYCODalkeithNewbattle@lbp.pnn.police.uk</a></td>
</tr>
<tr>
<td><img width="21" alt="Link" title="Link" src="/images/link_icon.jpg" height="21"/></td>
<td><a id="Template_ctl09_ctl00_linkToDocument" href="../../../../../pdf/SSS_A6%20postcard%20youth%20club_PRINTx2.pdf" target="_blank">Download the Street Soccer Scotland Poster (1.22MB pdf)</a></td>
</tr>
</tbody>
</table>
<p class="MsoNormal">&nbsp;</p>
