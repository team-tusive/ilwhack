...
<head><title>
	Safety cameras don't take holidays
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="lothian and borders police, press release, safety cameras, easter holidays" /><meta name="description" content="An increase in the number of motorists speeding over the Easter holidays has been detected by the average speed camera system on M9 at Junction 1A and on the M9 Spur." /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="safety_cameras_dont_take_holi.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Safety cameras don't take holi</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">23 April 2012 15:51</span>
...
<p class="MsoNormal">An increase in the number of motorists
speeding over the Easter holidays has been detected by the average
speed camera system on M9 at Junction 1A and on the M9 Spur.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Over the Easter school holidays 280 vehicles
were detected speeding, averaging 20 per day. Before Easter the
safety camera system was detecting an average of only three
vehicles per day.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Lothian and Borders Safety Camera Partnership
had previously reported a high rate of compliance when the cameras
first went &lsquo;live&rsquo; in January with seven offences being detected per
day.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">The average safety camera system is live all
day, every day and monitors all lanes. Motorists may believe that
if they change lanes when driving in an average camera system they
can avoid detection. This is not the case; if they are speeding
their vehicles will be detected.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Lothian and Borders Safety Camera Partnership
spokesperson, Victoria Edmond, said:</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;I&rsquo;m really surprised to see such an increase
in the number of people breaking the speed limit. I can only
presume that people were rushing to get away to make the most of
their Easter holidays. Unfortunately these people will be receiving
correspondence from the Safety Camera Partnership, which may spoil
the memories they have of their holidays. We are in the business of
making roads safer and motorists should remember that safety
cameras don&rsquo;t take holidays.&rdquo;&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">The average speed camera system has been
installed for the safety of the construction workers and all road
users whilst a road is built that will lead to the new Forth
Replacement Crossing. The road works are expected to last until
early 2013 and the safety cameras will remain fully operational
until the work is completed.</p>
                </div>
                <div class="cell250">
