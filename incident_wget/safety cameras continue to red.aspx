...
<head><title>
	Safety cameras continue to reduce fatalities
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Safety cameras continue to reduce fatalities, lothian and borders police, lbp, safety camera partnership, scottish safety camera statistics, scottish government,road safety" /><meta name="description" content="Lothian and Borders Safety Camera Partnership welcomes the publication of the Key Scottish Safety Camera Statistics for 2011 by the Scottish Government.  " /></head>
<body>
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Safety cameras continue to red</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">31 July 2012 11:07</span>
...
<tr>
<td>
<p class="MsoNormal">Lothian and Borders Safety Camera Partnership
welcomes the publication of the Key Scottish Safety Camera
Statistics for 2011 by the Scottish Government.&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">This latest annual report confirms the trends
in personal injury crash reduction as seen in previous
bulletins.<br />
<br />
It shows the number of people being killed or seriously injured at
safety camera sites throughout Scotland, for the last three years,
is on average 68% lower following camera enforcement.<br />
<br />
Collisions involving personal injuries have also reduced as an
average from 1,054 to 547 at these sites, a decrease of 48%.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Lothian and Borders Safety Camera Partnership
manager, Julie Roy commented:<br />
<br />
&ldquo;These figures show that the highly visible deterrent effect of
safety cameras continues to make a crucial contribution to
improving driving behaviour.<br />
<br />
The report also highlights that four out of five people in Scotland
support the use of safety cameras in helping to make our roads
safer.&rdquo; &nbsp;&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Kathleen Braidwood, RoSPA Road Safety Officer
said:<br />
<br />
&ldquo;The number of deaths on Scotland&rsquo;s roads fell again in 2011 and
this report reinforces the benefit of safety cameras in
contributing to the reduction in the number of crashes and
casualties.<br />
<br />
The use of safety cameras as an integral measure in achieving
casualty reduction is recognised in the Scottish Road Safety
Framework.&rdquo;</p>
<h1><br />
Related Internet Links</h1>
<table summary="box 3">
<tbody>
<tr>
<td><img width="21" alt="Link" title="Link" src="/images/link_icon.jpg" height="21"/></td>
<td><a onclick="window.open(this.href, '_blank'); return false;" href="http://www.scotland.gov.uk/Publications/2012/07/5039" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">Key Scottish
Safety Camera Statistics for 2011 publication</a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
...
<thead>
<tr>
<th scope="col" class="ImmTextAlign_Center ImmVerticalAlign_Top">
<img width="250" alt="A speed camera sign in West Lothian, with Police car in the background" title="A speed camera sign in West Lothian, with Police car in the background" src="/images/traffic%20car%20(west%20lothian%20sign)250a.jpg" height="163"/></th>
</tr>
</thead>
<tbody>
<tr>
<td><span class="legend">Road Policing car and speed<br />
camera sign</span></td>
</tr>
</tbody>
</table>
