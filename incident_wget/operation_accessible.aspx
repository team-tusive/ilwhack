...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="LBP, press release, Operation Accessible" /><meta name="description" content="Operation Accessible press release" /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="operation_accessible.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">08 December 2011 09:30</span>
...
<p class="MsoNormal">An operation targeting housebreakers in
Edinburgh continues&nbsp;with a fresh series of raids on addresses
in the Capital.&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">A total of nine addresses in the north and
west of the city were raided by officers as part of the enforcement
phase of <strong>Operation Accessible</strong>, and nine arrests
have been made so far.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">A &nbsp;number of &nbsp;people were arrested
and charged following&nbsp;a series of early morning raids, and
have appeared at Edinburgh Sheriff Court .</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Of the approximately 200 stolen items that
have been recovered by police during <strong>Operation
Accessible</strong>, a number have yet to be identified, and police
are seeking to reunite these stolen goods with their owners.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Images of the items are available on the
Lothian and Borders Police website, and members of the public who
suspect the stolen property belongs to them are urged to contact
police through the dedicated email address <a href="mailto:OperationAccessible@lbp.pnn.police.uk"><br />
<br />
OperationAccessible@lbp.pnn.police.uk</a></p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal"><strong>Chief Superintendent Gill
Imery</strong>, &lsquo;A&rsquo; Division (City of Edinburgh) Commander, said:
&ldquo;These items were recovered by officers over the past six months,
and we are hoping that we can reunite at least some of the goods
with their rightful owners.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;I would urge anyone who thinks that any of
these items may have been stolen from them to get in touch on the
dedicated email address.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;This morning&rsquo;s activity is further indication
of our commitment to take robust action against alleged serial
offenders suspected of housebreaking.&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;Lothian and Borders Police are determined to
protect the public from criminals whose activities blight local
communities, and to preventing crime from happening in the first
place.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;Operation Accessible has delivered a strong
message that we will pro-actively target housebreakers and other
criminals using intelligence, and that offenders will be brought to
justice.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">&ldquo;We continue to rely on information from the
public regarding suspected housebreakers and other criminals
operating in local communities, and we urge anyone with such
information to contact us directly or anonymously through
Crimestoppers.&rdquo;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">Anyone with any information should contact
Lothian and Borders Police on 0800 555 111, Crimestoppers on 0800
555 111.</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal"></p>
<table summary="box">
...
<td><a href="/information/operation_accessible.aspx">Unclaimed Property Pictures</a></td>
</tr>
</tbody>
</table>
                </div>
