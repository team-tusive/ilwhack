...
<head><title>
	Robberies initiative, Edinburgh
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian and borders police, press release, robberies initiative, edinburgh, operation arable" /><meta name="description" content="Police in Edinburgh today (Wednesday) launched an initiative aimed at reducing the number of robberies taking place on the streets of the Capital." /></head>
<body>
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Robberies initiative, Edinburg</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">15 February 2012 10:21</span>
...
<tbody>
<tr>
<td>Lothian and Borders Police&nbsp;have launched an initiative
aimed at reducing the number of robberies taking place on the
streets of Edinburgh.<br />
<br />
Operation Arable&nbsp;is intended to help prevent people falling
victim to muggers, while at the same time targeting offenders who
engage in robbery and associated crimes.<br />
<br />
Officers will be using a variety of tactics, including targeted and
intelligence-led patrols, as well as providing advice to people on
how to keep themselves and their valuables safe.<br />
<br />
As part of the enforcement activity already underway, officers from
Operation Arable have arrested a 39-year-old man in connection with
an alleged assault and robbery that happened in Blackford Road on
January 30, and a similar incident that happened in St Peter's
Place a short time later.<br />
<br />
DCI Cunningham added: "Robbery remains a policing priority for
Lothian and Borders Police. Not only can this type of crime have a
devastating impact on the victim, it also heightens the fear of
crime within local communities.<br />
<br />
"Operation Arable sends a clear message that Lothian and Borders
Police is committed to protecting our communities by bringing
offenders to justice.<br />
<br />
"At the same time, we want to minimise the risk of people becoming
victims of robbery, and community officers will be working with our
partners in the Council to distribute postcards and posters, with
tips on how people can keep their valuables safe.<br />
<br />
"Further crime prevention tips are available on the Lothian and
Borders Police website."<br />
<br />
DCI Cunningham added: "As ever, we rely on the public for
information on criminals operating in local communities, and we are
appealing for people to contact us with any information they have
about criminals who have been involved in robberies that have taken
place in their area.<br />
<br />
"Rest assured that any information received will be acted on, and
treated in the strictest confidence."<br />
<br />
Anyone with any information should contact Lothian and Borders
Police on 0131 311 3131, or Crimestoppers in confidence and
complete anonymity on 0800 555 111.</td>
<td class="ImmTextAlign_Left ImmVerticalAlign_Top">
<p><a onclick="window.open(this.href, '_blank'); return false;" href="/pdf/MuggingPoster-hi-res%20FINAL.pdf" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}"><img width="250" alt="'Pay attention: muggers do', awareness raising postcard" title="'Pay attention: muggers do', awareness raising postcard" src="/images/muggers250.jpg" height="186"/></a></p>
<table style="WIDTH: 250px" summary="box">
<tbody>
<tr>
<td><span class="legend">"Robbery can have a devastating
effect<br />
on the victim" - DCI Cunningham</span></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
...
<td><a onclick="window.open(this.href, '_blank'); return false;" href="/pdf/MuggingPostcard%20FINAL.pdf" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">'Pay attention: muggers do' -
postcard (2.13MB pdf)</a></td>
</tr>
<tr>
<td><img width="21" alt="Link" title="Link" src="/images/link_icon.jpg" height="21"/></td>
<td><a onclick="window.open(this.href, '_blank'); return false;" href="/pdf/MuggingPoster-hi-res%20FINAL.pdf" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}">'Pay attention: muggers do'
- poster (5.99MB pdf)</a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<p><a onclick="window.open(this.href, '_blank'); return false;" href="/pdf/MuggingPoster-hi-res%20FINAL.pdf" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}"><img width="250" alt="'Pay attention: muggers do', awareness raising postcard" title="'Pay attention: muggers do', awareness raising postcard" src="/images/muggers2_250.jpg" height="186"/></a></p>
<table style="WIDTH: 250px" summary="box">
<tbody>
<tr>
<td><span class="legend">Officers will use a variety of
tactics,<br />
including targeted and intelligence-led<br />
patrols.</span></td>
</tr>
</tbody>
</table>
