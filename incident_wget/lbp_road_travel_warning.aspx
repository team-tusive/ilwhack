...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="Lothian and Borders Police, press release, road warning, Bill Skelly, non essential travel" /><meta name="description" content="Lothian and Borders Police are advising the public against all non-essential travel after 2pm today, as the exceptional weather is expected to grow more severe across the Force area this afternoon. " /></head>
<body>
...
<li><a href="/contact_us.aspx" title="Contact Us" class="L0nc">Contact Us</a></li>
    ...
    <form name="aspnetForm" method="post" action="lbp_road_travel_warning.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">08 December 2011 13:46</span>
...
<p>Lothian and Borders Police are advising the public against all
non-essential travel after 2pm today, as the exceptional weather is
expected to grow more severe across the Force area this
afternoon.<br />
<br />
Assistant Chief Constable Bill Skelly said: "Our advice is based on
information from weather forecasters that there will be high winds,
with gusts of up to 90 miles per hour affecting the Lothian and
Borders Police Force area.<br />
<br />
"This guidance applies to both&nbsp;road users&nbsp;and
pedestrians, who could be putting themselves at considerable risk
by travelling in these conditions.<br />
<br />
"The weather has already had a significant impact on the roads
network in our area, with the Forth Road Bridge closed to traffic.
The high winds are also causing problems for high-sided
vehicles.<br />
<br />
"We are receiving continuous updates from the Met Office advising
of severe weather, and I would ask the public to pay close
attention to weather and road updates and act accordingly.<br />
<br />
"Rest assured that this advice is not given lightly, but is based
on ensuring public safety."<br />
<br />
Chief Constable David Strang has chaired a meeting of the Lothian
and Borders Strategic Co-ordinating Group, where all public
authorities were represented, to co-ordinate the response to the
adverse weather conditions.<br />
<br />
The five local authorities, NHS Lothian and NHS Borders, Lothian
and Borders Fire and Rescue Service, Met Office, Scottish Ambulance
Service, SEPA, Forth Ports and Coastguard met to discuss the latest
information on the developing weather picture and minimise the
impact of the weather on our communities.<br />
<br />
Mr Strang said: "Many services, including education, have been
disrupted and there has been serious impact on travel. During this
spell, I would urge the public to take extra care and refer to
information which is available from a number of sources, including
our own organisations' websites."</p>
                </div>
                <div class="cell250">
