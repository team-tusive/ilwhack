...
<head><title>
	Doorstep crime enforcement, West Lothian
...
<meta name="GENERATOR" content="Immediacy .NET CMS - Licensed To : Lothian &amp; Borders Police Board" /><meta name="keywords" content="lothian and borders police, press release, doorstep crime, west lothian" /><meta name="description" content="Lothian and Borders Police and their partners are today carrying out a multi-agency enforcement day as part of an ongoing campaign to target doorstep crime in West Lothian." /></head>
<body>
...
<noscript><div>Browser does not support script.</div></noscript>
        ...
        <div id="breadcrumb">
			...
			<li>Doorstep crime enforcement, We</li>
            ...
            <div id="main">
                <div class="cell724">
	                <h1>
    	                <span id="Template_NewsDate1_lblDate" style="float:right">20 March 2012 14:58</span>
...
<p>Lothian and Borders Police and their partners are today carrying
out a multi-agency enforcement day as part of an ongoing campaign
to target doorstep crime in West Lothian.<br />
<br />
Local officers will join representatives from organisations
including SEPA, Trading Standards and VOSA for the initiative,
which aims to identify bogus callers and rogue traders operating
within the county.<br />
<br />
The agencies will monitor the main arterial routes through West
Lothian and carry out regular and random checks on vehicles and
individuals passing through the area.<br />
<br />
An inspection area has been set-up within the car park of the TESCO
supermarket in Bathgate and anyone who comes to the attention of
the participating organisations during the operation will be
subject to a number of various checks.<br />
<br />
Police will also provide a presence within the store to engage with
local shoppers and offer information on identifying doorstep
criminals as well as issuing advice on how to prevent falling
victim to bogus callers or rogue traders.<br />
<br />
Justice Minister, Kenny MacAskill will be in attendance to speak
with the respective agencies and discuss the issue of doorstep
crime and how it can be addressed.<br />
<br />
Superintendent Graham Jones said: "Doorstep criminals prey on the
most vulnerable members of our communities and their actions can
have a devastating impact for their victims.<br />
<br />
"Today's activity demonstrates the zero-tolerance approach Lothian
and Borders Police and our partners take when dealing with bogus
callers and rogue traders and should send a clear message to
criminals operating within West Lothian that we are committed to
bringing them to justice.<br />
<br />
"This campaign, however, is as much about prevention as it is about
detection of crime and so local officers will be available to
discuss any concerns the public have relating to doorstep crime in
their area.<br />
<br />
"Anyone who would like further crime prevention advice should
contact their local policing team."</p>
                </div>
                <div class="cell250">
